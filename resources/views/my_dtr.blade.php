                        ...
                        <form method="POST" action="{{ route('my_dtr_post') }}">
                            ...
                            <td>
                                <div class="mt-4" >
                                    ...
                                    type="date" id="start_date" name="start_date" value="{{$payroll_start??0}}" required autofocus autocomplete="">
                            ...
                            <td>
                                <div class="mt-4">
                                    ...
                                    <input class="block mt-1 border-gray-300 dark:border-gray-700 dark:bg-gray-700 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
                                    type="date" id="end_date" name="end_date" value="{{$payroll_end??0}}" required autofocus autocomplete="">
